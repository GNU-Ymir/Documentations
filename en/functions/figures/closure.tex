...
\begin{tikzpicture}
  ...
  \draw[line width=1pt] ($(LEFT.east)+(0.18, 6.9)$) rectangle ($(LEFT.east)+(7.02, 3.48)$);
  \fill[blue!10] ($(LEFT.east)+(0.2, 6.5)$) rectangle ($(LEFT.east)+(7, 3.5)$);
  \draw[Box] ($(LEFT.east)+(3.5, 6.7)$) -- ($(LEFT.east)+(3.5, 6.7)$) node[anchor=center]{\emph{foo}};

  \draw[Box] ($(LEFT.east)+(0.5, 6.0)$) -- ($(LEFT.east)+(0.5, 6.0)$) node[anchor=center]{\textbf{\textit{i}}};
  \draw[line width=1pt] ($(LEFT.east)+(0.3, 6.4)$) rectangle ($(LEFT.east)+(6.8, 5.6)$); 
  \draw[Box] ($(LEFT.east)+(3.5, 6)$) -- ($(LEFT.east)+(3.5, 6)$) node[anchor=center]{$30$};
  
  
  \draw[Box] ($(LEFT.east)+(0.5, 4.5)$) -- ($(LEFT.east)+(0.5, 4.5)$) node[anchor=center]{\textbf{\textit{x}}};
  \draw[line width=1pt] ($(LEFT.east)+(0.3, 5.4)$) rectangle ($(LEFT.east)+(6.8, 3.6)$);
  \draw[line width=1pt] ($(LEFT.east)+(1, 4.5)$) rectangle ($(LEFT.east)+(6.8, 4.5)$);	

  \draw[Box] ($(LEFT.east)+(3.5, 5)$) -- ($(LEFT.east)+(3.5, 5)$) node[anchor=center]{\emph{closure~=}~0xfa45b987};
  \draw[Box] ($(LEFT.east)+(3.5, 4)$) -- ($(LEFT.east)+(3.5, 4)$) node[anchor=center]{\emph{ptr~=~foo\_lambda}};
  ...
  \fill[applegreen!20] ($(LEFT.east)+(10.2, 7.9)$) rectangle ($(LEFT.east)+(17, 7)$);

  \draw[Box] ($(LEFT.east)+(13.8, 7.5)$)  ($(LEFT.east)+(13.8, 7.5)$) node[anchor=center]{$30$};

  \draw[Box] ($(LEFT.east)+(13.8, 6.7)$) -- ($(LEFT.east)+(13.8, 6.7)$) node[anchor=center]{\textbf{.}};
  \draw[Box] ($(LEFT.east)+(13.8, 6.5)$) -- ($(LEFT.east)+(13.8, 6.5)$) node[anchor=center]{\textbf{.}};
  \draw[Box] ($(LEFT.east)+(13.8, 6.3)$) -- ($(LEFT.east)+(13.8, 6.3)$) node[anchor=center]{\textbf{.}};
