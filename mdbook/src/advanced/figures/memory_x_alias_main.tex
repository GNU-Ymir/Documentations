...
\begin{tikzpicture}
  ...
  \draw[Box] ($(LEFT.east)+(3.5, 3)$) -- ($(LEFT.east)+(3.5, 3)$) node[anchor=center]{\emph{ptr~=}~0xfa45b987};
  ...
  \draw[thick,->,shorten >=1pt] ($(LEFT.east)+(7.3, 3)$) to [out=0,in=180] node[below left, yshift=3mm] {} ($(LEFT.east)+(9.9, 7.5)$);
